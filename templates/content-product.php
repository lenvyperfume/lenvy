...
<article <?php post_class('product-card group relative flex flex-col'); ?>>
	...
	<a href="<?php echo esc_url(
 	get_permalink(),
 ); ?>" class="block overflow-hidden rounded-sm bg-neutral-100 aspect-[3/4] mb-4">
  	...
  	?>
		...
		<?php if ($product->is_on_sale()): ?>
			...
			<span class="absolute top-3 left-3 bg-brand-700 text-white text-[10px] font-bold uppercase tracking-widest px-2 py-1">
...
?>
		...
		<h3 class="text-sm font-semibold text-brand-950 leading-snug mb-2">
			<a href="<?php echo esc_url(get_permalink()); ?>" class="hover:text-brand-700 transition-colors">
				<?php the_title(); ?>
			</a>
		</h3>
