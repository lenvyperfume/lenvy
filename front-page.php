	...
	<section class="hero relative flex items-center justify-center min-h-[80vh] overflow-hidden bg-neutral-950">
		...
		<div class="container mx-auto px-4 max-w-screen-xl relative z-10 text-center text-white py-20">
			...
			<p class="max-w-xl mx-auto text-neutral-300 text-lg leading-relaxed mb-12">
				<?php echo esc_html( lenvy_field( 'hero_subtitle', __( 'Discover rare and exclusive fragrances curated for the discerning.', 'lenvy' ) ) ); ?>
			</p>
			<?php
			$hero_cta_url   = lenvy_field( 'hero_cta_url', class_exists( 'WooCommerce' ) ? wc_get_page_permalink( 'shop' ) : home_url( '/shop' ) );
			...
			get_template_part(
				...
				[
					...
					'url'     => $hero_cta_url,
					'variant' => 'outline',
					'classes' => 'border-white text-white hover:bg-white hover:text-neutral-900',
				]
			);
			?>
		</div>
	...
	<section class="featured-products py-20 bg-white">
		<div class="container mx-auto px-4 max-w-screen-xl">
			<header class="text-center mb-12">
				...
				<h2 class="text-3xl sm:text-4xl font-light tracking-tight text-neutral-900">
