...
<footer id="colophon" class="site-footer bg-neutral-950 text-neutral-400 mt-auto">
	<div class="container mx-auto px-4 max-w-7xl">
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-16">
     	...
     	home_url('/'),
     ); ?>" class="text-white text-lg font-semibold tracking-widest uppercase hover:text-neutral-300 transition-colors" rel="home">
						<?php bloginfo('name'); ?>
					</a>
				<?php endif; ?>
				<?php
    ...
    ?>
			...
			<!-- Footer navigation -->
			<nav class="col-span-1 lg:col-span-2 flex flex-col sm:flex-row gap-10" aria-label="<?php esc_attr_e(
   	'Footer Navigation',
   	'lenvy',
   ); ?>">
				<?php wp_nav_menu([
