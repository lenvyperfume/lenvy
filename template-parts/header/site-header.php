...
<header id="masthead" class="site-header sticky top-0 z-40 bg-white border-b border-neutral-100 shadow-sm">
	<div class="container mx-auto px-4 max-w-7xl">
    	...
    	'fallback_cb' => false,
     	...
     	wc_get_cart_url(),
     ); ?>" class="relative flex items-center text-brand-950 hover:text-brand-700 transition-colors" aria-label="<?php esc_attr_e(
	'View cart',
	'lenvy',
); ?>">
      ...
      if ($cart_count > 0): ?>
							<span class="absolute -top-2 -right-2 flex items-center justify-center h-4 w-4 rounded-full bg-brand-700 text-white text-[10px] font-bold leading-none">
      ...
      ?>
				...
				<button
					type="button"
					class="md:hidden p-2 -mr-2 text-brand-950 hover:text-brand-700 transition-colors"
