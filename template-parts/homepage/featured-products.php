	...
	<div class="lenvy-container">
   	...
   	?>
      	...
      	elseif (function_exists('wc_placeholder_img')): ?>
							<?php echo wc_placeholder_img('woocommerce_thumbnail', ['class' => 'w-full h-full object-cover']); ?>
						<?php endif; ?>
        	...
        	'variant' => 'sale',
					...
					<div>
						...
						<div class="text-sm font-medium text-neutral-700">
							<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped — WC price HTML is trusted
       echo $price_html; ?>
						</div>
					</div>
