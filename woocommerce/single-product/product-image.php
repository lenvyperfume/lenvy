...
<div class="relative overflow-hidden bg-neutral-50 aspect-product">
	<?php echo wp_get_attachment_image($all_ids[0], 'woocommerce_single', false, [
...
<div class="flex gap-2 mt-3 overflow-x-auto scrollbar-hide" data-gallery-thumbs>
	<?php foreach ($all_ids as $i => $img_id): ?>
		...
		<button
			type="button"
			class="shrink-0 w-16 h-16 overflow-hidden bg-neutral-50 border-2 transition-colors duration-150 <?php echo 0 === $i
   	? 'border-black'
   	: 'border-transparent hover:border-neutral-300'; ?>"
		...
		>
			<?php echo wp_get_attachment_image($img_id, [80, 80], false, [
